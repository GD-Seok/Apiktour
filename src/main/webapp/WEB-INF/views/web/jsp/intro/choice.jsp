...
<head>
    <meta charset="UTF-8"> 
 	<link href="${pageContext.request.contextPath}/web/css/intro/choice.css" type="text/css" rel="stylesheet">
    ...
    $( function() {
        ...
        $('#saveBtn').click(function(){
			...
			$('#costype').attr('action','${pageContext.request.contextPath}/index.do?CONTROL=intro&CONNAME=palyPro').submit();
