...
<head>
	...
	<link href="<c:url value='/resources/css/intro/choiceRest_slider.css' />" rel="stylesheet"></link>
	<link href="<c:url value='/resources/css/intro/choiceRest.css' />" rel="stylesheet"></link>
	...
	$(function(){		
		...
		$('#saveBtn').click(function(){
			var restLevel=$( "#flat-slider-vertical-1" ).slider( "value" );		
			$('#sliderVal').val(restLevel);
			//alert($('#sliderVal').val());	
			return true;
		})
	});	
