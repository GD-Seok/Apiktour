...
<head>
    <meta charset="UTF-8"> 
    <link href="${pageContext.request.contextPath}/web/css/intro/playpro.css" type="text/css" rel="stylesheet">
    ...
    $( function() {
	    $('#rsBtn').click(function(){
			...
			$('#parameter').attr('action','${pageContext.request.contextPath}/index.do?CONTROL=result&CONNAME=result').submit();
